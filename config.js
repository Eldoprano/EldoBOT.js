const config = {
  ...
  intents: ["GUILDS","GUILD_MESSAGES","DIRECT_MESSAGES","GUILD_BANS","GUILD_EMOJIS_AND_STICKERS","GUILD_INTEGRATIONS","GUILD_WEBHOOKS","GUILD_INVITES","GUILD_MESSAGE_REACTIONS","DIRECT_MESSAGE_REACTIONS"],
